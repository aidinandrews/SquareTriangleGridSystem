...
////    treeNode is a node element structure for a BinaryBalancedTree
////    BinaryBalancedTree is a class for a Balanced Binary Tree
...
//};
//
//typedef struct _BinaryBalancedTreeNode treeNode;
//struct _BinaryBalancedTreeNode {
//    void* val;
//    // plus node mgmt info ...
//};
//
...
//    treeNode* root;
//public:
//    BinaryBalancedTree() { root = (treeNode*)0; }   // constructor
//    ~BinaryBalancedTree() { freetree(); }        // destructor
//
//    treeNode* insert(void*) {};       // insert data into the tree
//    treeNode* find(void*) {};         // find data from the tree
//    treeNode* next(treeNode*) {};        // get next tree node
//    treeNode* prev(treeNode*) {};        // get previous tree node
//    void    remove(treeNode*) {};     // remove node from the tree
...
//class EventQueue {
//    int      numEvents;                // total number of events in array
//    int      nextEventIndex;                // index of next event on queue
...
//{
//    nextEventIndex = 0;
//    numEvents = 2 * P.n;           // 2 vertex events for each edge
//    Edata = (Event*)new Event[numEvents];
//    Eq = (Event**)new (Event*)[numEvents];
//    for (int i = 0; i < numEvents; i++)           // init Eq array pointers
//        Eq[i] = &Edata[i];
//
...
//    qsort(Eq, numEvents, sizeof(Event*), E_compare);
//}
//
...
//    BinaryBalancedTree      Tree;          // balanced binary tree
//public:
...
//    treeNode* nd = Tree.insert(s);
//    treeNode* nx = Tree.next(nd);
//    treeNode* np = Tree.prev(nd);
//    if (nx != (treeNode*)0) {
